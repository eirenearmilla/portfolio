...
export default function HeroSection() {
    ...
    return (
        <>
            {/* HERO SECTION */}
            <section className="w-full max-w-4xl lg:max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 pt-14 md:pt-30 py-10" >
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-3">
                    ...
                    <div className="order-2 md:order-1 text-center md:text-left pt-10 md:pt-0">
                        <p className="mb-4 flex items-center justify-center md:justify-start gap-2 font-mono text-md uppercase tracking-[0.15em] text-[#2B2118]">
                        ...
                        <p className="mt-6 max-w-xl mx-auto md:mx-0 text-base text-md lg:text-lg leading-relaxed text-[#2B2118]/80">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row items-center md:items-start justify-center md:justify-start gap-3">
                            <a
                                href="#projects"
                                className="w-full sm:w-auto px-6 py-3 rounded-md bg-[#B5482A]/90 text-[#F7EDE2] text-sm font-mono font-medium text-center hover:bg-[#B5482A]/70 transition-colors duration-200"
                            >
                                View My Work
                            </a>
                        ...
                        <div className="relative">
                            ...
                            <AnimatePresence>
                                <motion.div
                                    ...
                                    className="relative w-64 h-76 md:w-80 md:h-[60vh] lg:w-[40vh] lg:h-[50vh] overflow-hidden border-4 border-[#2B2118] rounded-3xl shadow-xl shadow-[#2B2118]/15"
                                >
                                    <Image
                                        src="/GradPic.jpg"
